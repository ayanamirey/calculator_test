# Написать функцию calculator, которая принимает на вход строку, содержащую два целых числа и
# один знак арифметической операции + = * / и возвращает результат выполнения этой операции.
